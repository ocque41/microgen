        ...
        {CARDS.map((card) => {
          ...
          return (
            <motion.button
              ...
              className={
                "group relative flex min-h-[160px] flex-col justify-between rounded-2xl border border-[color:var(--border-glass)] bg-[color:var(--surface-overlay-90)] p-5 text-left shadow-[0_30px_90px_-70px_rgba(0,0,0,0.85)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[color:var(--accent)]"
              }
              style={{
                boxShadow: isActive
                  ? "0 30px 90px -60px color-mix(in srgb, var(--status-info) 45%, transparent)"
                  : "0 24px 80px -68px color-mix(in srgb, var(--surface-base) 72%, transparent)",
              }}
      ...
      <AnimatePresence>
        {activeId ? (
          <motion.section
            ...
            aria-live="polite"
            className="relative flex min-h-[200px] flex-1 flex-col justify-between rounded-3xl border border-[color:var(--border-strong)] bg-[color:var(--surface-overlay-92)] p-6 text-left shadow-[0_60px_120px_-90px_rgba(0,0,0,0.9)]"
          ...
          >
            ...
            <span
              ...
              style={{
                background:
                  CARDS.find((card) => card.id === activeId)?.accent ?? "var(--status-surface-info)",
              }}
            />
          </motion.section>
        ) : null}
